...
- `CREED_dpi`: The CREED experiment for ML-based Deep Packet Inspection has been described in-depth in its own artifact repository, which is included here as subrepo. It contains all relevant descriptions to build the required FPGA-hardware and execute the experiments used for the paper. 

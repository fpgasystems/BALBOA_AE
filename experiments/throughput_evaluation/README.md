...
### Baseline: 
The baseline experiments for RDMA-connections between commercial RNICs as shown in Figure 4 have been obtained by using the standard linux perftest utility (https://github.com/linux-rdma/perftest). 
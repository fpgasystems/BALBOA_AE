...
/**
 * @brief ML preprocessing kernel: applies dense-feature transforms (clamp negatives, log1p)
 *        to each 32-bit lane of an incoming 512-bit AXIS beat.
 *
 * @param[in]  axi_in  Incoming AXI stream
 * @param[out] axi_out Outgoing AXI stream; preprocessed data
 */
void ml_preprocessing (
